      ...
      <table>
       <tr>
          ...
          <tr>
           ...
           <td>
               <asp:DropDownList ID="types_DropDownList" runat="server" CssClass="shadow" Height="25px" Width="200px">
                   ...
                   <asp:ListItem>Jarnal</asp:ListItem>
                   <asp:ListItem>Conference</asp:ListItem>
                   <asp:ListItem>Books Volum</asp:ListItem>
               </asp:DropDownList>
           </td>
       </tr>
          ...
          <tr>
            ...
            <td>
                <asp:DropDownList ID="index_DropDownList" CssClass="shadow" Height="25px" Width="200px" runat="server">
                    <asp:ListItem>-Select a Item-</asp:ListItem>
                    <asp:ListItem>Scopus</asp:ListItem>
                    <asp:ListItem>Non Scopus</asp:ListItem>
                </asp:DropDownList>
           </td>
          </tr>
          ...
          <tr>
            ...
            <td>
                <asp:DropDownList ID="year_DropDownList" CssClass="shadow" Width="200px" runat="server">
                    <asp:ListItem>-Select a Item-</asp:ListItem>
